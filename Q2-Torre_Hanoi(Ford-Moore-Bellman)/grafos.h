...
void ford_moore_bellman(int grafo[MAX_VERTICES][MAX_VERTICES], int inicio, int distancias[MAX_VERTICES], int anteriores[MAX_VERTICES]); //// Algoritmo de Ford-Moore para encontrar o menor caminho(Ótimo)
